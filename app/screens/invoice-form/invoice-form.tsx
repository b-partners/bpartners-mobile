          ...
          return (
            <>
              ...
              <View>
                ...
                />
                <Button
                  onPress={() => setFieldValue("products", [...values.products, {
                    ...productInitialValue,
                    id: uuid.v4().toString()
                  }])}
              ...
              <View>
                <View style={[FLEX_ROW, CENTERED_FLEX, SEPARATOR_STYLE, VALIDITY_PERIOD_TEXT_STYLE]}>
                    <Text tx={"invoiceFormScreen.invoiceForm.limitedValidityPeriod"}
                ...
                <View style={[FLEX_ROW, CENTERED_FLEX]}>
                  <GridHeaderContent headerTx={"invoiceFormScreen.invoiceForm.personalizedNotice"}
                                     bodyText={"Bon pour accord Signature du client"} style={FULL}/>
                  <Switch style={FULL} value={legalNotice} onToggle={newValue => setLegalNotice(newValue)} />
                </View>
                <Separator style={SEPARATOR_STYLE} />
                <View style={[FLEX_ROW, CENTERED_FLEX]}>
                  <GridHeaderContent headerTx={"invoiceFormScreen.invoiceForm.viewMail"}
                                     bodyText={values["customer"]["email"] || ""} style={FULL} />
