    ...
    <View style={[CONTAINER_STYLE, containerStyle]}>
      <TouchableOpacity onPress={handlePress}>
        ...
        {isEditing ? (
          ...
          <ReadOnlyText value={field.value} placeholderStyle={props.placeholderStyle} defaultValue={defaultValue}
                        placeholder={placeholder} suffix={suffix} prefix={prefix} />
        )}
  ...
  if (placeholder && !value && !defaultValue) {
    return (
      <View style={FLEX_ROW_STYLE}>
        ...
        <Text numberOfLines={1} text={`${placeholder}`}
