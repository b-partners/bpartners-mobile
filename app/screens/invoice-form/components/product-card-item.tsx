...
const DELETE_ACTION_CONTAINER_STYLE: ViewStyle = {
              ...
              <View style={CONTAINER_STYLE}>
                ...
                <View style={BOTTOM_INFO_STYLE}>
                  ...
                  <EditableTextField
                    ...
                    defaultValue={'1'}
                  />
                  <View style={{ ...EDITABLE_TF_CONTAINER, flexDirection: 'row', borderRightWidth: 0, borderBottomWidth: 0, borderLeftWidth: 0 }}>
                    <EditableTextField title={'TVA'} formName={'tva'} suffix={' %'} defaultValue={'0'} />
