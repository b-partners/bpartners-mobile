        ...
        <KeyboardLayout setKeyboardOpen={setKeyboardOpen}>
            ...
            >
                ...
                >
                    ...
                    <LabelledDropdown control={control} name={'covering'} labelTx={'annotationScreen.labels.covering'}
                                      data={coveringOptions}/>
                    <LabelledDropdown control={control} name={'slope'} labelTx={'annotationScreen.labels.gradient'}
                                      data={slopeOptions}/>
                    <LabelledDropdown control={control} name={'wearness'} labelTx={'annotationScreen.labels.usury'}
                                      data={wearnessOptions}/>
                    <LabelledDropdown control={control} name={'wearLevel'} labelTx={'annotationScreen.labels.usuryRate'}
                                      data={rangeOptions}/>
                    <LabelledDropdown control={control} name={'moldRate'} labelTx={'annotationScreen.labels.moldRate'}
                                      data={rangeOptions}/>
                    <Controller
                        control={control}
                        name='comment'
