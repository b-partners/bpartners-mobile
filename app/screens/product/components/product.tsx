      ...
      <TouchableOpacity style={{ paddingBottom: spacing[2], paddingTop: spacing[0], flex: 1 }}>
        <View style={{ display: 'flex', flexDirection: 'row', marginBottom: spacing[2], justifyContent: 'space-between' }}>
          <View style={{ flexDirection: 'row' }}>
            <Text text={item.description} style={{ fontSize: 16, color: palette.textClassicColor, marginTop: spacing[4], marginHorizontal: spacing[1] }} />
          </View>
          <Text
            text={printCurrencyToMajors(item.totalPriceWithVat)}
