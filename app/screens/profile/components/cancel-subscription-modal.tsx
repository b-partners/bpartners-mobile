...
export const CancelSubscriptionModal = () => {
  ...
  return (
    <View style={{ paddingHorizontal: 10 }}>
      <Text style={{ color: palette.purple, fontWeight: "bold", fontSize: 18, marginBottom: 10 }}>Confirmation de l'annulation du renouvellement automatique</Text>
      ...
      <View style={{ marginTop: 10, display: "flex", gap: 10, flexDirection: "column", paddingStart: 15 }}>
        <Text style={{ color: "black", textAlign: "justify" }}>• Vous conserverez l'accès à toutes les fonctionnalités de votre abonnement jusqu'au <Text style={{ color: "black", fontWeight: "bold" }}>{formatedEndDate}</Text></Text>
        <Text style={{ color: "black", textAlign: "justify" }}>• À la fin de cette période, votre abonnement ne sera pas renouvelé automatiquement et aucun paiement supplémentaire ne sera débité.</Text>
