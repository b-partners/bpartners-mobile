...
export const Customer: React.FC<CustomerProps> = props => {
    ...
    return (
        <View style={styles.viewContainer}>
            <TouchableOpacity style={styles.container} onPress={() => setCreationModal({
                type: 'EDITION',
                state: true,
                customer: item,
            })}>
                <View style={{
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <Text text={item.firstName} style={{
                            fontSize: 16,
                        ...
                        <Text text={item.lastName}
                              style={{fontSize: 16, color: palette.textClassicColor, marginTop: spacing[4]}}/>
                    </View>
                    <Text text={item.phone} style={{
                        fontSize: 16,
                        color: palette.textClassicColor,
                        marginTop: spacing[4],
                ...
                <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', flex: 1}}>
                    <View style={{
                        ...
                        <Text text={`${item.email}`}
                              style={{fontSize: 14, color: palette.greyDarker, marginLeft: spacing[1]}}/>
                        <View style={DATE_CONTAINER}>
                            <BulletSeparator style={{marginLeft: spacing[2]}}
