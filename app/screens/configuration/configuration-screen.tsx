...
export const ConfigurationScreen: FC<DrawerScreenProps<NavigatorParamList, 'configuration'>> = observer(function ConfigurationScreen({navigation}) {
    ...
    const hasErrors =
        errors.unpaidRelaunch ||
        errors.draftRelaunch;
    ...
    return (
        <Provider>
            <ErrorBoundary catchErrors='always'>
                <Header headerTx='configurationScreen.title' leftIcon={'back'}
                ...
                <View testID='ConfigurationScreen'
                    ...
                    <Text tx={'configurationScreen.RelaunchFrequency'}
                          style={{color: palette.black, fontSize: 18, paddingBottom: spacing[1],marginBottom: spacing[4], borderBottomWidth: 1, borderColor: palette.lighterGrey}}/>
