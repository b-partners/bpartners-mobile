  ...
  return (
    <View testID='DemoScreen' style={FULL}>
      ...
      <Screen style={CONTAINER} preset='scroll' backgroundColor={color.transparent}>
        <Header headerTx='demoScreen.howTo' leftIcon='back' onLeftPress={goBack} style={HEADER} titleStyle={HEADER_TITLE} />
        ...
        />
        <View>
          <Button style={DEMO} textStyle={DEMO_TEXT} tx='demoScreen.reactotron' onPress={demoReactotron} />
          <Text style={HINT} tx={`demoScreen.${Platform.OS}ReactotronHint` as const} />
        </View>
        <Button style={DEMO} textStyle={DEMO_TEXT} tx='demoScreen.transactionList' onPress={() => navigation.navigate('transactionList')} />
