...
storiesOf('FormRow', module)
  ...
  .add('Assembled', () => (
    <Story>
      <UseCase text='Fully Assembled' usage='FormRow has many parts designed to fit together.  Here is what it looks like all assembled.'>
        <FormRow preset='top'>
        ...
        <FormRow preset='middle'>
          <Text style={TEXT_STYLE_OVERRIDE}>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi officia quo rerum impedit asperiores hic ex quae, quam dolores vel odit doloribus,
            tempore atque deserunt possimus incidunt, obcaecati numquam officiis.
          </Text>
        </FormRow>
        <FormRow preset='middle'>
      ...
      <UseCase text='Alternatives' usage='Less commonly used presets.'>
        <FormRow preset='clear'>
          <Text style={TEXT_STYLE_OVERRIDE}>
            My borders are still there, but they are clear. This causes the text to still align properly due to the box model of flexbox.
          </Text>
        </FormRow>
