...
export const presets = {
   ...
   *
   * Pick this one if you are unsure your content will fit the screen
        or if you want to automatically adapt to screen size.
   *
  ...
  auto: {
    ...
    // inner: {} as ViewStyle,
    offset: {
      percent: 0.92, // Manipulates the height comparison by percentage values.
      // For example, 0.92 enables scroll when the contents height reaches 92% of the screen.
