  ...
  .add('Behaviour', () => (
    <Story>
      <UseCase text='The Checkbox' usage='Use the checkbox to represent on/off states.'>
        <Toggle initial={false}>{({ on, toggle }) => <Checkbox value={on} onToggle={toggle} text='Toggle me' />}</Toggle>
      </UseCase>
    ...
    <Story>
      ...
      <UseCase text='.fillStyle' usage='Override the fill style'>
        <Toggle initial={false}>
          {({ on, toggle }) => (
            <View>
              <Checkbox text='Fill er up' value={on} fillStyle={{ backgroundColor: 'red', borderRadius: 8 }} onToggle={toggle} />
            </View>
          )}
        </Toggle>
      </UseCase>
      ...
      <UseCase text='Array style' usage='Use array styles'>
        <Toggle initial={false}>
          {({ on, toggle }) => (
            <View>
              <Checkbox text='Check it twice' value={on} onToggle={toggle} style={arrayStyle} outlineStyle={arrayOutlineStyle} fillStyle={arrayFillStyle} />
            </View>
          )}
        </Toggle>
      </UseCase>
